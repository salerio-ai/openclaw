          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.bustly/tools/sherpa-onnx-tts/runtime",
            ...
            },
            {
              ...
              "archive": "tar.bz2",
              "extract": true,
              "targetDir": "~/.bustly/tools/sherpa-onnx-tts/models",
...
1. Download the runtime for your OS (extracts into `~/.bustly/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.bustly/tools/sherpa-onnx-tts/models`)

Update `~/.bustly/openclaw.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.bustly/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.bustly/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
