...
function mockSnapshot(token = "abc") {
  ...
  mocks.resolveControlUiLinks.mockReturnValue({
    httpUrl: "http://127.0.0.1:17999/",
    wsUrl: "ws://127.0.0.1:17999",
  });
}
...
describe("dashboardCommand", () => {
  ...
  it("opens and copies the dashboard link by default", async () => {
    ...
    expect(mocks.copyToClipboard).toHaveBeenCalledWith("http://127.0.0.1:17999/?token=abc123");
    expect(mocks.openUrl).toHaveBeenCalledWith("http://127.0.0.1:17999/?token=abc123");
