...
describe("applyCliProfileEnv", () => {
  it("fills env defaults for dev profile", () => {
    ...
    const expectedStateDir = path.join(path.resolve("/home/peter"), ".bustly-dev");
  ...
  it("uses OPENCLAW_HOME when deriving profile state dir", () => {
    ...
    expect(env.OPENCLAW_STATE_DIR).toBe(path.join(resolvedHome, ".bustly-work"));
    expect(env.OPENCLAW_CONFIG_PATH).toBe(path.join(resolvedHome, ".bustly-work", "openclaw.json"));
  });
});
