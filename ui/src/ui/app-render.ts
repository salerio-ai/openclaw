...
import { renderOnboard } from "./views/onboard.ts";
  ...
  if (bustlyState.bustlyIsLoggedIn && bustlyState.bustlyUserInfo) {
    ...
    return html`
      <div class="bustly-user-controls">
        ...
        ${
          bustlyState.bustlyUserMenuOpen
            ? html`
  ...
  return html`
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
        ...
        ${TAB_GROUPS.map((group) => {
          ...
          return html`
            <div class="nav-group ${isGroupCollapsed && !hasActiveTab ? "nav-group--collapsed" : ""}">
              ...
              >
                <span class="nav-label__text">${t(`nav.${group.label.toLowerCase()}`)}</span>
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "onboard" ? renderOnboard(state) : nothing}
      </main>
