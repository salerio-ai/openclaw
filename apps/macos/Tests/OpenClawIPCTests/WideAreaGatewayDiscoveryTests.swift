    ...
    @Test func discoversBeaconFromTailnetDnsSdFallback() {
        ...
        let context = WideAreaGatewayDiscovery.DiscoveryContext(
            ...
            dig: { args, _ in
                ...
                if recordType == "SRV" {
                    return "0 0 17999 steipetacstudio.openclaw.internal."
                }
                if recordType == "TXT" {
                    return "\"displayName=Peter\\226\\128\\153s Mac Studio (OpenClaw)\" \"gatewayPort=17999\" \"tailnetDns=peters-mac-studio-1.sheep-coho.ts.net\" \"cliPath=/Users/steipete/openclaw/src/entry.ts\""
                }
                return ""
            })
        ...
        #expect(beacon.port == 17999)
        #expect(beacon.gatewayPort == 17999)
