...
# Remote Gateway
openclaw acp --url wss://gateway-host:17999 --token <token>
...
openclaw acp client --server-args --url wss://gateway-host:17999 --token <token>
...
```bash
openclaw config set gateway.remote.url wss://gateway-host:17999
