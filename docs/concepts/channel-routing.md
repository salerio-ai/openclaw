...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.bustly/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.bustly`):

- `~/.bustly/agents/<agentId>/sessions/sessions.json`
